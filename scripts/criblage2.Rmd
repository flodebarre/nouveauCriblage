...
plotReg <- function(reg, xmin = "2022-04-01", addNotes = FALSE, ymax = 0.2, ymin = 1*10^-3, withMut = TRUE, col = colLiss, scale = "logit", percent = FALSE, lang = "FR", ...){
