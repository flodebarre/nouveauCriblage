...
plotMut0(dat.France[ix, "dateMid"], dat.France[ix, "nb_C1"], dat.France[ix, "nb_C0"], col = "red", thetit = "Proportion des tests criblés avec la mutation L452R, France", ymin = ym, ymax = yM)
# Add data "delisse"
plotMut0(dat.France[ix, "dateMid"], dat.France[ix, "nb_C1.dl"], dat.France[ix, "nb_C0.dl"], col = "orange", add = TRUE, pch = 1)
```
